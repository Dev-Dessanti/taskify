...
- Name: Taskify E2E Tests >> should validate form fields
- Location: C:\Users\Felipe\Documents\taskify-frontend\taskify-frontend\tests\taskify.spec.ts:136:3
...
Call log:
  - waiting for locator('textarea[placeholder="Digite a descrição da tarefa"]')

    at C:\Users\Felipe\Documents\taskify-frontend\taskify-frontend\tests\taskify.spec.ts:140:16
```
