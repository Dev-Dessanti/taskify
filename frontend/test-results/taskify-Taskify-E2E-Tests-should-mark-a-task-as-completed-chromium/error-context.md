...
- Name: Taskify E2E Tests >> should mark a task as completed
- Location: C:\Users\Felipe\Documents\taskify-frontend\taskify-frontend\tests\taskify.spec.ts:72:3
...
Call log:
  - waiting for locator('input[placeholder="Digite o título da tarefa"]')
    ...
    at C:\Users\Felipe\Documents\taskify-frontend\taskify-frontend\tests\taskify.spec.ts:76:16
```
...
```ts
   ...
   3 | // Dados de teste
   4 | const TEST_USER = {
   5 |   email: `felipe.campos_3${Date.now()}@hotmail.com`, // Email único para cada teste
   6 |   password: 'felipe123',
   7 | };
   8 |
   9 | const TEST_TASK = {
   10 |   title: 'Test Task',
